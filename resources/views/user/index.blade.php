          ...
          <div class="row">
            ...
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center overflow-hidden" style="background-image: url('{{ asset('assets/img/question.jpg')}}'); background-size: cover;">
                ...
                <h4 class="mt-5 text-white font-weight-bolder position-relative">"Join the Fun. Sign Up Now!"</h4>
                <p class="text-white position-relative">Quizzes: Where learning meets excitement, sparking joy through engaging challenges and endless discovery</p>
              </div>
            </div>
          </div>
        </div>
